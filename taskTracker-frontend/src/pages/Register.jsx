...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        const message = result.message || 'Account created successfully! Redirecting to login...';
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white/50 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  disabled={loading}
                  className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white/50 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg className="w-5 h-5 text-gray-400 group-focus-within:text-blue-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.018-4.118A3.001 3.001 0 0112 6a3 3 0 00-4.018 2.882M9 12l2 2 4-4m5.018-4.118A3.001 3.001 0 0112 6a3 3 0 00-4.018 2.882" />
                  </svg>
                </div>
                <input
                  id="confirmPassword"
